 ...
 * Uses upload class
 */
function upload_attachment($form_name, $forum_id, $local = false, $local_storage = '', $is_message = false, $local_file = false) {
...
function submit_post($mode, $subject, $username, $topic_type, &$poll, &$data, $update_message = true, $update_search_index = true) {
    ...
    if ($mode == 'post') {
        ...
        $post_mode = ($data['topic_replies_real'] == 0) ? 'edit_topic' : (($data['topic_first_post_id'] == $data['']) ? 'edit_first_post' : (($data['topic_last_post_id'] == $data['post_id']) ? 'edit_last_post' : 'edit'));
    }
    ...
    if ($post_mode == 'post') {
        ...
        $message = $message . "<a href='http://www.hiveusers.com' style='text-decoration: none;'><span style='font-size: 34px; color: #2e4e68;'><b>hive</b></span>";
        $message = $message . "<span style='font-size: 26px; color: #83ac52; text-decoration:none;'><b>users.com</b></span></a><br/><br/>Forum Notification</div>";
        $message = $message . "<div style='margin-bottom:10px;'><span style='color: #000;'><i>Hello</i>,<br/><br/></span>";

        $message = $message ."A new topic <b><span style='color: #2e4e68'>". $topicName . "</span></b> was added to forum - <span style='color: #2e4e68;'>" . $forumName . "</span> <br>by <span style='color: #2e4e68;'>" . $user_name . " - " . $uplantname . "</span><br/>
                    Please click <a href = 'http://www.hiveusers.com/forums/viewtopic.php?f=" . $forumId . "&t=" . $catId . "'><b>here</b></a> to view the topic";

        $message = $message."</div><div style='border-top: solid 1px #aaa; color:#aaa; padding: 5px;'><center>This is a generated mail, please do not Reply.</center></div></div>";
    ...
    if ($post_mode == 'post' || $post_mode == 'reply') {
        ...
        if ($isReply) {
            ...
            $message = "<div style='width: 100%; '><div style='border-bottom: solid 1px #aaa; margin-bottom: 10px;'>";
            $message = $message . "<a href='http://www.hiveusers.com' style='text-decoration: none;'><span style='font-size: 34px; color: #2e4e68;'><b>hive</b></span>";
            $message = $message . "<span style='font-size: 26px; color: #83ac52; text-decoration:none;'><b>users.com</b></span></a><br/>Forum Notification</div>";
            $message = $message . "<div style='margin-bottom:10px;'><span style='color: #000;'><i>Hello</i>,<br/><br/></span>";

            $message = $message ."A new post <b><span style='color: #2e4e68'>". $postName . "</span></b> was added to topic - <span style='color: #2e4e68;'>" . $topicName . "</span> in the forum <span style='color: #2e4e68;'>". $forumName ."</span> <br>by <span style='color: #2e4e68;'>" . $user_name . " - " . $uplantname .  "</span><br/>
                        Please click <a href = 'http://www.hiveusers.com/forums/viewtopic.php?f=" . $forumId . "&t=" . $topicId . "#p" . $catId . "'><b>here</b></a> to view the topic";
    ...
    if (isset($sql_data[POSTS_TABLE]['sql'])) {
		...
		$uplantname = $uplantdata['plantName'];
            ...
            $message = $message . "<a href='http://www.hiveusers.com' style='text-decoration: none;'><span style='font-size: 34px; color: #2e4e68;'><b>hive</b></span>";
            $message = $message . "<span style='font-size: 26px; color: #83ac52; text-decoration:none;'><b>users.com</b></span></a><br/>Forum Notification</div>";
            $message = $message . "<div style='margin-bottom:10px;'>";

            $message = $message ."Post <b><span style='color: #2e4e68'>". $postName . "</span></b> of topic - <span style='color: #2e4e68;'>" . $topicName . "</span> in the forum <span style='color: #2e4e68;'>". $forumName ."</span> was edited <br>by <span style='color: #2e4e68;'>" . $user_name . " - " . $uplantname . "</span><br/>
                        Please click <a href = 'http://www.hiveusers.com/forums/viewtopic.php?f=" . $forumId . "&t=" . $topicId . "#p" . $catId . "'>here</a> to view the topic";
