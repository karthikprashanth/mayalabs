		...
		<?php } ?>
			...
			<div class="postbody" id="pr<?php echo $_topic_review_row_val['POST_ID']; ?>">
				...
				<ul class="profile-icons">
					<?php if ($_topic_review_row_val['U_MCP_DETAILS']) {  ?><li class="info-icon"><a href="<?php echo $_topic_review_row_val['U_MCP_DETAILS']; ?>"><span><?php echo ((isset($this->_rootref['L_POST_DETAILS'])) ? $this->_rootref['L_POST_DETAILS'] : ((isset($user->lang['POST_DETAILS'])) ? $user->lang['POST_DETAILS'] : '{ POST_DETAILS }')); ?></span></a></li><?php } ?>
